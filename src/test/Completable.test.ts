...
describe('Completable Suite', () => {
  ...
  describe('Completable Implementation Tests', () => {
    ...
    beforeEach(() => {
      completable = concurrency.createCompletable({});
    });
  ...
  describe('Completable State Management Tests', () => {
    ...
    beforeEach(() => {
      completable = concurrency.createCompletable<string>({ contracts: contracts });
    });
  ...
  describe('Completable Config Variants Tests', () => {
    it('should create completable with contracts only', () => {
      const completable = concurrency.createCompletable({
        contracts: contracts
      });
  ...
  describe('Completable Generic Type Tests', () => {
    ...
    it('should create completable for string type', () => {
      const completable = concurrency.createCompletable<string>({
        contracts: contracts,
    ...
    it('should create completable for number type', () => {
      const completable = concurrency.createCompletable<number>({
        contracts: contracts,
        initialValue: 42
      });
    ...
    it('should create completable for boolean type', () => {
      const completable = concurrency.createCompletable<boolean>({
        contracts: contracts,
        initialValue: true
      });
  ...
  describe('Completable Completion Lifecycle Tests', () => {
    ...
    beforeEach(() => {
      completable = concurrency.createCompletable({ contracts: contracts });
    });
  ...
  describe('Completable Edge Cases Tests', () => {
    ...
    it('should handle empty object as initial value', () => {
      const completable = concurrency.createCompletable<Record<string, never>>({
        contracts: contracts,
        initialValue: {}
      });
  ...
  describe('Completable notify() Method Tests', () => {
    ...
    it('should register observer via notify and receive completion', () => {
      const completable = concurrency.createCompletable<string>({ contracts: contracts });
      const autoClose = completable.open();
