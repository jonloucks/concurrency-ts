...
import { Idempotent, guard as isIdempotent, Config as IdempotentConfig } from "@jonloucks/concurrency-ts/api/Idempotent";
import { AutoOpen, AutoClose, CONTRACTS, isPresent, Contracts } from "@jonloucks/contracts-ts";
...
import { IdempotentFactory, CONTRACT as IDEMPOTENT_FACTORY } from "@jonloucks/concurrency-ts/api/IdempotentFactory";
